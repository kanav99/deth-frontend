...
const ContractAdder = () => (
  <>
    ...
    <VStack spacing={8}>
      ...
      <Heading fontSize={"4xl"}>Add a new contract documentation</Heading>
      <VStack width={"80%"}>
      ...
      <VStack spacing={8} paddingX={100} paddingBottom={50}>
        ...
        >
          ...
          >
            ...
            <Feature title="Learns as it goes" icon={<FcMindMap />}>
              ...
              contracts involved in the transaction - leading to accurate
        ...
        <VStack spacing={70}>
          <HStack>
            <Box width={"full"}>
              <Text>
                ...
                them write documentation which doubles up as dialogue for the
                API.
              </Text>
            </Box>
            <Box width={"full"}>
          ...
          <HStack>
            ...
            <Box width={"full"}>
              Smart-Contract Developers generate ABI and Documentation and
              upload it to the{" "}
              <ChakraLink href="/admin">deth's upload tool</ChakraLink>{" "}
        ...
        <HStack>
          <Box width={"full"}>
            <Text>
              ...
              are tokens and adds it to the list of pattern matching rules. Due
              to this, we get a double advantage - we are completely accurate
              that further queries for these tokens will be accurate and we
              cache the token metadata like symbol from Infura.
            </Text>
          </Box>
          <Box width={"full"}>
            <Img src={code1} />
      ...
      <Box textAlign="center" fontSize="xl">
        ...
        >
          <VStack alignItems={"end"}>
            <Heading fontSize={40}>deth</Heading>
            <Text fontWeight={"thin"}>© 2022 Kanav Gupta</Text>
          </VStack>
        </HStack>
      </Box>
    </ChakraProvider>
